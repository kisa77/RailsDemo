...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Cart', 'Event', 'LineItem', 'Person', 'Product', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Cart', 'Event', 'LineItem', 'Person', 'Product', 'User']
  ...
  #     configure :line_items, :has_many_association 
  #     configure :person, :has_many_association 
  ...
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :hashed_password, :string 
